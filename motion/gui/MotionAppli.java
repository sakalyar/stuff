...
public class MotionAppli {
    ...
    private void createController() {
        ...
        buttons.get(BKey.PAUSE).addActionListener(
        		new ActionListener() {
            		@Override
            		public void actionPerformed(ActionEvent e) {
            			BKey.PAUSE.executeCommand(animator);
        		}
    		}
        );
    ...
    private void updateButtons() {
    	...
    	buttons.get(BKey.RESUME).setEnabled(animator.isPaused() && !animator.hasStopped());
    	buttons.get(BKey.TERMINATE).setEnabled(animator.hasStarted());
        /*****************/
    }

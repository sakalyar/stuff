...
//            	frame.add(scroller,BorderLayout.CENTER);
        ...
        menuItems.get(Item.REOPEN).addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                /** A COMPLETER **/
            	try {
					model.saveCurrentDocIntoFile(model.getFile());
					updateScrollerAndEditorComponents();
				} catch (AssertionError | IOException asr) {
        ...
        menuItems.get(Item.SAVE).addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	try {
					...
					model.saveCurrentDocIntoFile(model.getFile());
					updateScrollerAndEditorComponents();
				} catch (AssertionError | IOException | BadLocationException asr) {
					displayError("REOPENING FILE");
				}
...
//            	File f = selectSaveFile();
        ...
        menuItems.get(Item.QUIT).addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                /** A COMPLETER **/
            	boolean x = true;
            	System.out.println(model.isSynchronized());
    ...
    private boolean confirmAction() {
    	...
    	int input = JOptionPane.showConfirmDialog(null, 
                "Voulez-vous fermer et reouvrir la fenetre courante? Les données ne seron pas sauvegardées!", "Fermeture d'une fenetre", 
